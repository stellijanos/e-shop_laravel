                ...
                <div class="card-body">
                    ...
                    <form action="{{url('admin/employee/'.$employee->id)}}" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control w-50" type="text" id="firstname" name="firstname" value="{{$employee->firstname}}" placeholder="Firstname">
                            <label for="firstname">Firstname</label>
                        </div>
                        <div class="form-floating mb-3 w-50">
                            <input class="form-control" type="text" id="lastname" name="lastname" value="{{$employee->lastname}}" placeholder="Lastname">
