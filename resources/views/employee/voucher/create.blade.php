...
<div class="card">
    <div class="card-header">
        @include('employee.includes.breadcrumb', ['current' => 'Create', 'group' => 'vouchers'])
    </div>
    <div class="card-body">
        <form action="{{route('vouchers.store')}}" method="post">
            ...
            <div class="form-floating mb-3">
                <input class="form-control w-50" type="number" min="1" id="value" name="value" value="{{old('value')}}">
            ...
            <div class="form-floating mb-3">
                <input class="form-control w-50" type="date" id="end_date" name="end_date" value="{{old('end_date')}}">
